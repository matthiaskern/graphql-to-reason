...
if (!supported) {
  console.error("graphq-to-reason does not support this platform :(");
  console.error("");
  console.error(
    "graphq-to-reason comes prepacked as built binaries to avoid large"
  );
  console.error("dependencies at build-time.");
  console.error("");
  console.error(
    "If you want graphq-to-reason to support this platform natively,"
  );
